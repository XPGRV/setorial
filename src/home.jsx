...
import { Beef, Car, Factory, Truck, Landmark, Search, ChevronRight, Sun, Moon, Sprout, Utensils } from 'lucide-react'
...
const SECTORS = [
  ...
  { label: 'Transportes',     sub: 'Acompanhamento de logística, rodovias, ferrovias e infraestrutura de transportes.', icon: Truck },
