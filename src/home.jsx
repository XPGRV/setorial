...
function TopbarMesh({ accent = '#2f8fc4', spacing = 12, intensity = 0.22, speed = 1, children }) {
  ...
  React.useEffect(() => {
    ...
    const frame = (now) => {
      ...
      bg.addColorStop(0, rgba(mix(navy, acc, 0.12), 1))
      bg.addColorStop(0.4, rgba(mix(navy, acc, 0.025), 1))
      ...
      for (const d of g.dots) {
        ...
        const idle = 0.04 + 0.025 * Math.sin(d.bx * 0.045 + d.by * 0.03 + t * 1.4)
