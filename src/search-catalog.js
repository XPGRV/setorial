...
const RAW_ITEMS = [
  ...
  ['weg','transformadores',null,'WEG · Transformadores','transformador transformadores transformer ppi secex exportacao'],
  ['weg','eie',null,'WEG · EIE','eie motores automacao exportacao exportacoes secex sh6 brasil santa catarina sc'],
  ...
  ['weg','transformadores','card-weg-transformadores-exportacoes','Exportações de Transformadores','transformador transformadores exportacao exportacoes secex sh6 brasil santa catarina sc'],
  ['weg','transformadores','card-weg-transformadores-exportacoes-sazonal','Exportações de Transformadores · Sazonal','transformador transformadores exportacao exportacoes sazonal secex sh6 brasil santa catarina sc'],
  ['weg','eie','card-weg-eie-exportacoes','Exportações EIE','eie motores automacao exportacao exportacoes secex sh6 brasil santa catarina sc'],
  ['weg','eie','card-weg-eie-exportacoes-sazonal','Exportações EIE · Sazonal','eie motores automacao exportacao exportacoes sazonal secex sh6 brasil santa catarina sc'],
  ['weg','peers','card-weg-peers','Peers · Comparação de Preço','peers cotacao preco price weg abb nidec regal rexnord eaton siemens schneider ge vernova hitachi hyosung eie gtd'],
  ['weg','peers','card-weg-peers-pe','Peers · Comparação de P/E','peers pe price earnings valuation multiplo weg abb nidec regal rexnord eaton siemens schneider ge vernova hitachi hyosung eie gtd'],
